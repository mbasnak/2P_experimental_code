...
from socket_client_wind_WLITOBIN_open_loop import SocketClient  # note: different code for wind experiments

def experiment_code(experiment=None, time=3, logfile=None, wind_dir=270):
