         ...
         serial.Serial(self.COM, self.baudrate, timeout=self.serialTimeout) as ser:
            ...
            while not self.done:
                ...
                if ready[0]:
                    ...
                    if ((math.floor(self.time_elapsed)==1500 or math.floor(self.time_elapsed)==2100 or math.floor(self.time_elapsed)==2700 or math.floor(self.time_elapsed)==3300) and (self.bar_jump == True)):
                    ...
                    if ((math.floor(self.time_elapsed)==2099 or math.floor(self.time_elapsed)==2699 or math.floor(self.time_elapsed)==3299) and (self.bar_jump == False)):
                        self.bar_jump = True
                    ...
                    if ((math.floor(self.time_elapsed)==1200 or math.floor(self.time_elapsed)==1800 or math.floor(self.time_elapsed)==2400 or math.floor(self.time_elapsed)==3000) and (self.wind_jump == True)):
                   ...
                   #reset self.jump 1 sec before the wind jump has to happen
                    if ((math.floor(self.time_elapsed)==1799 or math.floor(self.time_elapsed)==2399 or math.floor(self.time_elapsed)==2999) and (self.wind_jump == False)):
                        self.wind_jump = True
                    ...
                    #turn on the bar
                    if ((math.floor(self.time_elapsed)==600) and (self.bar == False)):
                        self.bar = True
                    ...
                    #turn on the wind
                    if ((math.floor(self.time_elapsed)==900) and (self.wind == False)):
                        self.wind = True
                    #turn off the wind
                    if ((math.floor(self.time_elapsed)==600) and (self.wind == True)):                    
                        self.wind = False
