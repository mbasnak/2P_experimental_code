...
class SocketClientBarJump(object):
            ...
            while not self.done:
                ...
                if ready[0]:
                   ...
                   #reset self.jump 1 sec before the gain change
                    ...
                    self.heading_with_gain = (self.heading_with_gain + self.deltaheading*self.gain_yaw + self.jump_size) % (2*np.pi)
                    ...
                    if self.print:
                        ...
                        print('jump size: {0}'.format(self.jump_size))
