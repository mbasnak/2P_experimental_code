...
if (strcmp(run_obj.experiment_type,'Spontaneous_walking')==1)
    if (strcmp(task, 'panels_Closed_Loop_wind_Closed_Loop') == 1 | strcmp(task, 'panels_Closed_Loop_X_Open_Loop_Y_wind_Closed_Loop') == 1 | strcmp(task, 'panels_Open_Loop_wind_Closed_Loop') == 1)
