function [fwd_histo, ang_histo, fly_pos_histo] = display_trial_both(sid, tid, run_obj, trial_time, trial_data, session_fig, fwd_histogram, ang_histogram, fly_pos_histogram)
%%% code to plot the results of visual panels and wind trials
...
[ t, stim_pos_panel, stim_pos_motor, vel_for, vel_yaw, fly_pos] = process_data_both( trial_time, trial_data, x_pixels); 
